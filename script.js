...
if input = rock return Rock
	...
	const input = prompt(`Round ${round}: Enter Rock, Paper, or Scissors\nYour Score: ${humanScore} || System Score: ${computerScore}`);

	  if (!input) return getHumanChoice(round);//replay current round if nothing is entered
...
function playGame() {
  ...
  if (humanScore > computerScore) {
    console.log("You are the overall winner!");
		alert(`You are the overall winner! Great Job\nYour Score: ${humanScore} || System Score: ${computerScore}`);
  } else if (computerScore > humanScore) {
    console.log("Computer wins the game!");
		alert(`The System won the game! Better luck next time\nYour Score: ${humanScore} || System Score: ${computerScore}`);
  } else {
    console.log("It's a tie game!");
		alert(`It's a tie! Close one\nYour Score: ${humanScore} || System Score: ${computerScore}`);
  }
}
